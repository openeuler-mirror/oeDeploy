...
class Node(models.Model):
    ...
    arch = models.CharField('节点架构', null=True, blank=True, max_length=32)
    os_type = models.CharField('操作系统', null=True, blank=True, max_length=64)
...
class TaskNode(models.Model):
    ...
    node_name = models.CharField('节点名称', max_length=32, help_text="相同节点在不同任务下可以拥有不同名称")
    node_role = models.CharField('节点角色', max_length=32, help_text="相同节点在不同任务下可以拥有不同角色")
